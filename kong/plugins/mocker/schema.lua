return {
  fields = {
    ...
    query_param_mapping = {type = "string", default = "{['mock1']={['code']={404},['message']={'{Service is Not Available}'}},['mock2']={['code']={403},['message']={'{<html><h1>Service is Not Available</h1></html>}'}}}"},
  }
}
